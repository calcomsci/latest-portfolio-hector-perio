    ...
    return (
        <div>
            ...
            <div className='home-container'>
                ...
                <p className='bio-text'>Hector Perio is a Full Stack Software Engineer with a focused technical backend programming language in C++. In front end software development: React, JavaScript, HTML, node.js, Inquirer, and CSS.
